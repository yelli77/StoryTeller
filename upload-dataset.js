...
async function startTransfer() {
    ...
    const files = fs.readdirSync(SOURCE_DIR).filter(f => f.match(/\.(png|jpg|jpeg|webp)$/i));
    console.log(`🚀 Starting Transfer of ${files.length} images to Pod ${POD_ID}...`);
    ...
    console.log("---------------------------------------------------");
    console.log(`🎉 Transfer Complete! ${successCount}/${files.length} images uploaded.`);
    console.log("Images are now in the RunPod 'input' folder.");
}
