...
function constructWorkflow(uploadedImageName) {
    ...
    return {
        ...
        "17": { "inputs": { "images": ["30", 0], "filename_prefix": "REACTOR_TEST_CLARA" }, "class_type": "SaveImage" }
    };
}

async function runTest() {
    const localPath = 'public/clara_ref.png';
    const uploadedName = await uploadImage(localPath, `REF_REACTOR_CLARA.png`);
